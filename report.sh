...
### Heavily adapted from below - Works with Proxmox setups but probably really flimsy. No support provided.
...
echo "Content-Transfer-Encoding: 8bit" >> "${logfile}"
